...
#define VP_EXAMPLE_COMPUTE_MIN_API_VERSION VK_MAKE_VERSION(1, 2, 198)
#endif

#if defined(VK_VERSION_1_0) && \
    defined(VK_EXT_debug_utils)
#define VP_EXAMPLE_compute_debug 1
#define VP_EXAMPLE_COMPUTE_DEBUG_NAME "VP_EXAMPLE_compute_debug"
#define VP_EXAMPLE_COMPUTE_DEBUG_SPEC_VERSION 1
#define VP_EXAMPLE_COMPUTE_DEBUG_MIN_API_VERSION VK_MAKE_VERSION(1, 0, 0)
#endif
